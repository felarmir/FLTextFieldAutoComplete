#
#  Be sure to run `pod spec lint FLTextFieldAutoComplete.podspec' to ensure this is a
...
Even though creating the autocomplete feature over a UITextField is not a big issue, dealing with screen rotation, keyboard position, the look and feel, etc, makes this task harder than expected.
  ...
  # Or just: s.author    = "Denis Andreev"
  # s.authors            = { "Denis Andreev" => "felarmir@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Denis Andreev"
